...
```
aws ecr get-login-password --region eu-central-1 --profile [PROFILE] | docker login --username AWS --password-stdin 381492178973
...
```
docker tag backend-loadtest:latest 381492178973
.dkr.ecr.eu-central-1.amazonaws.com/backend-loadtest:latest
```
